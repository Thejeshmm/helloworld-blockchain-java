...
public class IncentiveSetting {
    ...
    //一个挖矿难度周期内的区块数量
    public static final long INTERVAL_BLOCK_COUNT = 4;
    //一个挖矿周期内的期望周期耗时时间(单位：毫秒)
    public static final long INTERVAL_TIME = BLOCK_TIME * INTERVAL_BLOCK_COUNT;
    //区块初始奖励
    public static final long BLOCK_INIT_INCENTIVE = 10000L * 100000000L;
    //激励金额减半周期：每210000个区块激励减半
    public static final long INCENTIVE_HALVING_INTERVAL = 5000L;
}
